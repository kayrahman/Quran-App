...
internal const val KEY_NAVIGATION = "key_navigation_code"
internal const val KEY_NAVIGATION_CODE_MY_ACCOUNT = 2001
...
const val TAG_CHOOSE_POST_CATEGORY = "choosePostCategory"