...
class SearchItemListInjector(application:Application): AndroidViewModel(application) {
    ...
    fun provideSearchViewModelFactory(): SearchResultIViewModelFactory =
        SearchResultIViewModelFactory(
            getNoteRepository()
        )
}