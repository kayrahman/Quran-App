...
class MyCustomView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    init {
        ...
        if (attrs != null) {
            ...
            strokeColor = a.getColor(R.styleable.CustomCircleImageView_strokeColor, Color.TRANSPARENT)
            strokeWidth =
                a.getDimensionPixelSize(R.styleable.CustomCircleImageView_strokeWidth, 0).toFloat()
            highlightEnable = a.getBoolean(R.styleable.CustomCircleImageView_highlightEnable, true)
            highlightColor =
                a.getColor(R.styleable.CustomCircleImageView_highlightColor, DEF_PRESS_HIGHLIGHT_COLOR)
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
       ...
       // val halfStrokeWidth = mStrokePaint.strokeWidth
    ...
    protected fun drawBitmap(canvas: Canvas) {
       // canvas.drawOval(mBitmapDrawBounds, mBitmapPaint)
        //val space = RectF(0f, 0f, width.toFloat(), height.toFloat())
        canvas.drawRoundRect(mBitmapDrawBounds,0F,0F, mBitmapPaint)
